...
function e(e, t, n) {
        ...
        "function" == typeof i ? i = new i(t, {detail: n}) : ((i = r.createEvent("Event")).initEvent(t, !1, !1), i.detail = n),
        e.dispatchEvent(i)
    }
    function t(e) {
    ...
    function w(n, i, o, a) {
        ...
        n instanceof Map ? (s =
            ...
            d = c.arrayish,
            l = c.arrayish ? C : c.setish ? x : P
        ) : a ? (s = f(n), l = N) : (s = f(n), l = S);
        const h = document.createElement("span");
        h.className = "observablehq--expanded",
        o && h.appendChild(r(o));
        ...
        l = l(n);
        for (let e = 0; !(u = l.next()).done && e < 20; ++ e) 
            h.appendChild(u.value);
        ...
        if (! u.done) {
            ...
            t.addEventListener("mouseup", function (t) {
                ...
                u.done && h.removeChild(h.lastChild.previousSibling),
                e(h, "load")
            })
        }
        return h.appendChild(document.createTextNode(d ? "]" : "}")),
        h
    }
    function* g (e) {
        for (const [t, n] of e) 
    ...
    function* E (e) {
        for (let t = 0, n = e.length; t < n; ++ t) 
            t in e && (yield M(t, h(e, t), "observablehq--index"));
        
        for (const t in e) 
            ! n(t) && d(e, t) && (yield M(t, h(e, t), "observablehq--key"));
        
        for (const t of c(e)) 
            yield M(o(t), h(e, t), "observablehq--symbol")
    ...
    function* N (e) {
        for (const t in b(e)) 
            yield M(t, h(e, t), "observablehq--key");
    ...
    function* S (e) {
        for (const t in e) 
            d(e, t) && (yield M(t, h(e, t), "observablehq--key"));
    ...
    function k(e, n, i, o) {
        let a,
            ...
            u,
            c = t(e);
        if (e instanceof Map ? (a =
            `Map(${ e.size
        })`, s = T) : e instanceof Set ? (a =
            `Set(${ e.size
        })`, s = A) : c ? (a =
            `${ e.constructor.name
        }(${
            ...
            c = u.arrayish,
            s = u.arrayish ? U : u.setish ? O : F
        ) : (a = f(e), s = D), n) {
            const t = document.createElement("span");
            return t.className = "observablehq--shallow",
            i && t.appendChild(r(i)),
            t.appendChild(document.createTextNode(a)),
            t.addEventListener("mouseup", function (n) {
                j(t) || (n.stopPropagation(), se(t, k(e)))
            }),
            t
        }
        const d = document.createElement("span");
        d.className = "observablehq--collapsed",
        i && d.appendChild(r(i));
        ...
        d.addEventListener("mouseup", function (t) {
            j(d) || (t.stopPropagation(), se(d, w(e, 0, i, o)))
        }, !0),
        s = s(e);
        ...
        return l.done || d.appendChild(document.createTextNode(", …")),
    ...
    function* R (e) {
        ...
        for (const n = e.length; r < n; ++ r) 
            r in e && (r > t + 1 && (yield I(r - t - 1)), yield ae(h(e, r), !0), t = r);
        ...
        for (const t of c(e)) 
            yield z(o(t), h(e, t), "observablehq--symbol")
        
    }
    function* D (e) {
        for (const t in e) 
            d(e, t) && (yield z(t, h(e, t), "observablehq--key"));
    ...
    function ie(e, t, n) {
        ...
        i.className = "observablehq--function",
        n && i.appendChild(r(n));
        var o = i.appendChild(document.createElement("span"));
        return o.className = "observablehq--keyword",
    ...
    function ae(e, t, n, i, a) {
        ...
        switch (s) {
            ...
            case "function":
                return function (e, t) {
                    ...
                    switch (e.constructor && e.constructor.name) {
                        case "AsyncFunction": n = Z;
                            break;
                        case "AsyncGeneratorFunction": n = ee;
                            break;
                        case "GeneratorFunction": n = re;
                            break;
                        default: n = /^class\b/.test(i) ? te : ne
                    }
                ...
                return function (e, t, n, i) {
                    if (!1 === t) {
                        if (X(e, /["\n]/g) <= X(e, /`|\${/g)) {
                            ...
                            return n.className = "observablehq--string",
                        ...
                        if (o.length > K && ! n) {
                            ...
                            a.textContent = "`" + Y(o.slice(0, K).join("\n"));
                            const s = n.appendChild(document.createElement("span")),
                                l = o.length - K;
                            return s.textContent = `Show ${l} truncated line${
                                l > 1 ? "s" : ""
                            }`,
                    ...
                    return a.className = "observablehq--string",
                    a.textContent = JSON.stringify(e.length > 100 ? `${
                        e.slice(0, 50)
                    }…${
                        e.slice(-49)
                    }` : e),
            ...
            default:
                ...
                if (e instanceof Date) {
                    s = "date",
                    l = e,
                    e = isNaN(l) ? "Invalid Date" : function (e) {
                ...
                switch (oe.call(e)) {
                    case "[object RegExp]": s = "regexp",
                        e = function (e) {
                            return G.call(e)
                        }(e);
                        break;
                    case "[object Error]":
                    case "[object DOMException]": s = "error",
                        e = function (e) {
        ...
        return d.className = `observablehq--${s}`,
        d.textContent = e,
        c
    }
    function se(t, n) {
    ...
    class ue {
        ...
        fulfilled(t, n) {
            const {_node: r} = this;
            if ((!(t instanceof Element || t instanceof Text) || t.parentNode && t.parentNode !== r) && (t = ae(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"), r.classList.remove("observablehq--running", "observablehq--error"), r.firstChild !== t) 
                if (r.firstChild) {
    ...
    rejected(t, n) {
        ...
        n && o.appendChild(r(n)),
        o.appendChild(document.createTextNode((t + "").replace(le, ""))),
        i.appendChild(o),
        e(i, "error", {error: t})
    }
}
...
class FileAttachment {
    ...
    async image() {
        ...
        return new Promise((t, n) => {
            const r = new Image;
            new URL(e, document.baseURI).origin !== new URL(location).origin && (r.crossOrigin = "anonymous"),
            r.onload = () => t(r),
            r.onerror = () => n(new Error(`Unable to load file: ${
                this.name
            }`)),
            r.src = e
        })
...
function Ee(e) {
    ...
    let n = fe.get(t);
    return n || fe.set(t, n = fetch(t).then(e => {
        if (! e.ok) 
            throw new RequireError("unable to load package.json");
        
        return e.redirected && ! fe.has(e.url) && fe.set(e.url, n),
        e.json()
    })),
    n
}
RequireError.prototype.name = RequireError.name;
var Ce = Ne(async function (e, t) {
    if (e.startsWith(be) && (e = e.substring(be.length)), /^(\w+:)|\/\//i.test(e)) 
        return e;
    
    if (/^[.]{0,2}\//i.test(e)) 
        return new URL(e, null == t ? location : t).href;
    ...
    if (! n.version && null != t && t.startsWith(be)) {
        const e = await Ee(xe(t.substring(be.length)));
...
function Ne(e) {
    ...
    function r(e) {
        ...
        return n || t.set(e, n = new Promise((t, n) => {
            ...
            r.onerror = () => {
                n(new RequireError("unable to load module")),
                r.remove()
            },
            r.async = !0,
            r.src = e,
...
function Se(e) {
    ...
    for (const n of e) 
        for (const e in n) 
            ve.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {
                get: Pe(n, e)
            }) : t[e] = n[e]);
...
function Me(e, t, n) {
    ...
    he.push(me.call(t, qe) ? e => {
        const r = {},
            i = {
                exports: r
            };
        return Promise.all(pe.call(t, t => "exports" === (t += "") ? r : "module" === t ? i : e(t))).then(e => (n.apply(null, e), i.exports))
    } : e => Promise.all(pe.call(t, e)).then(e => "function" == typeof n ? n.apply(null, e) : n))
}
function $e(e) {
    return function () {
        return e
...
var Te = {
    ...
    element: function (e, t) {
        ...
        if (t) 
            for (var a in t) 
                ...
                Le.hasOwnProperty(r) ? o.setAttributeNS(Le[r], a, n) : o.setAttribute(a, n);
    ...
    input: function (e) {
        ...
        return null != e && (t.type = e),
        t
    },
    range: function (e, t, n) {
        1 === arguments.length && (t = e, e = null);
        var r = document.createElement("input");
        return r.min = e = null == e ? 0 : + e,
        r.max = t = null == t ? 1 : + t,
                    ...
                    i.forEach(function (n) {
                        ...
                        t.getLanguage(n.className) ? r() : e(Be + "async-languages/index.js").then(r => {
                            if (r.has(n.className)) 
                                return e(Be + "async-languages/" + r.get(n.className)).then(e => {
        ...
        return Promise.all([e("@observablehq/katex@0.11.1/dist/katex.min.js"), e.resolve("@observablehq/katex@0.11.1/dist/katex.min.css").then(et)]).then(function (e) {
            ...
            function r(e) {
                return function () {
                    ...
                    return t.render(Ze.apply(String, arguments), n, e),
    ...
    Object.defineProperties(this, {
        ...
        _rejector: {
            value: (r = this, function (e) {
                if (e === _t) 
                    throw new it(r._name + " is not defined", r._name);
...
function gt(e, t, n) {
    ...
    if (this._inputs.forEach(bt, this), t.forEach(vt, this), this._inputs = t, this._definition = n, this._value = void 0, n === ct ? i._variables.delete(this) : i._variables.add(this), e == this._name && r.get(e) === this) 
        ...
        if (this._name) 
         ...
         else if ((a = r.get(this._name)) === this) 
            r.delete(this._name);
         else {
            if (a._type !== ht) 
                throw new Error;
            ...
            1 === a._duplicates.size && (a = a._duplicates.keys().next().value, o = r.get(this._name), a._outputs = o._outputs, o._outputs = new Set, a._outputs.forEach(function (e) {
        ...
        }), o._duplicates = new Set([this, a]), i._dirty.add(a).add(o), i._updates.add(a).add(o), r.set(e, o)) : r.set(e, this)),
        this._name = e
    }
    return i._updates.add(this),
    i._compute(),
    this
}
function yt(e, t =[]) {
        ...
        value: function (e, t, n) {
            switch (arguments.length) {
                case 1: n = e,
                    ...
                    break;
                case 2: n = t,
                    "string" == typeof e ? t = null : (t = e, e = null)
            }
            return gt.call(this, null == e ? null : e + "", null == t ? [] : at.call(t, this._module._resolve, this._module), "function" == typeof n ? n : lt(n))
        },
        writable: !0,
        configurable: !0
    },
            ...
            for (const [o, a] of this._scope) {
                ...
                if (! n || n._type !== dt) 
                    if (a._definition === ut) {
                        var r = a._inputs[0],
                            i = r._module;
                        e.import (r._name, o, t.get(i) || (i._source ? i._copy(new yt(e._runtime, e._builtins), t) : i))
                    }
                 else 
                    e.define(o, a._inputs.map(xt), a._definition)
...
writable: !0,
configurable: !0}, _resolve : {
value: function (e) {
    var t,
        n = this._scope.get(e);
    if (! n) 
        if (n = new mt(ft, this), this._builtins.has(e)) 
            ...
            for (const n of t._scope.values()) 
                if (n._definition === ut) {
                    const t = n._inputs[0]._module,
                        r = t._source || t;
                    if (r === this) 
                        return void console.warn("circular module definition; ignoring");
...
for (const e of r) {
    ...
    for (const i of e.variables) 
        i.from ? t.import (i.remote, i.name, l(i.from)) : t === s ? t.variable(n(i, r, e.variables)).define(i.name, i.inputs, i.value) : t.define(i.name, i.inputs, i.value),
        ++ r
    
}
return a},writable: !0,configurable: !0}}),Object.defineProperties(St.prototype, {_compute: {value: function () {
return this._computing || (this._computing = this._computeSoon())},writable: !0,configurable: !0},_computeSoon: {value: function () {
var e = this;
return new Promise(function (t) {
    Et(function () {
        t(),
        e._disposed || e._computeNow()
    })
...
function r(e) {
    0 == -- e._indegree && n.push(e)
}},writable: !0,configurable: !0},dispose: {value: function () {
this._computing = Promise.resolve(),
this._disposed = !0,
this._variables.forEach(e => {
    e._invalidate(),
    e._version = NaN
})},writable: !0,configurable: !0},module: {value: function (e, t = ct) {
let n;
if (void 0 === e) 
    return(n = this._init) ? (this._init = null, n) : new yt(this);

if (n = this._modules.get(e)) 
    return n;

this._init = n = new yt(this),
...
return n},writable: !0,configurable: !0},fileAttachments: {value: function (e) {
return t => {
    const n = e(t += "");
    if (null == n) 
